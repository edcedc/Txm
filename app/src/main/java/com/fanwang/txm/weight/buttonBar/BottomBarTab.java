package com.fanwang.txm.weight.buttonBar;
...
public class BottomBarTab extends FrameLayout {
    ...
    public void setSelected(boolean selected) {
        ...
        switch (tabPosition){
            case 0:
                mIcon.setBackgroundResource(selected == true ? R.mipmap.monitor_icon_monitor_click : R.mipmap.maininterface_icon_monito);
                break;
            case 1:
                mIcon.setBackgroundResource(selected == true ? R.mipmap.query_icon_query_click : R.mipmap.monitor_icon_monitor_icon_monitor_click);
                break;
            case 2:
                mIcon.setBackgroundResource(selected == true ? R.mipmap.workposition_icon_workposition : R.mipmap.monitor_icon_workposition);
                break;
            default:
                break;
        }
        mTvTitle.setTextColor(selected == true ? ContextCompat.getColor(mContext, R.color.blue_26A4E1) : ContextCompat.getColor(mContext, R.color.tab_unselect));
    }
