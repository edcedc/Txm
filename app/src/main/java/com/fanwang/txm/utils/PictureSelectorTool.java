...
public class PictureSelectorTool {
    ...
    public static void PictureSelectorImage(Activity act, List<LocalMedia> selectionMedi){
        PictureSelectorImage(act, selectionMedi, 9, PictureConfig.CHOOSE_REQUEST, true, false);
    }
